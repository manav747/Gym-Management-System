...
{
fstream fout;
fout.open("ww.txt", ios::out | ios::app);
...
if (back == "Y" || back == "y")
{
cout << "\n\n\t\t\t\t\t\t\t\tYou filled all Entries of " << i + 1 << "/" << mn << " member
successfully...";
getch();
cout << endl;
}
...
{
status1 = 1;
inf >> name >> age >> contact;
cout << "\n\n\n\n\n\n\n\n\n\n";
cout << "\t\t\t\t\t\t\t\t----------------------------------------------" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\tMembers's ID :" << id << endl
<< endl;
cout << "\t\t\t\t\t\t\t\tMembers's Name :" << name << endl
<< endl;
cout << "\t\t\t\t\t\t\t\tMember's Age :" << age << endl
<< endl;
cout << "\t\t\t\t\t\t\t\tMember's Address :" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\tMembers's Contact :" << contact << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t----------------------------------------------" << endl
<< endl;
...
while (!inf.eof())
{
inf >> id >> name >> age >> contact;
cout << "\t\t\t\t\t\t" << id << "\t\t\t" << name << "\t\t\t" << age << "\t\t\t" << contact << endl
<< endl;
}
cout << "\t\t\t\t\t\t--------------------------------------------------------------------------------" << endl
<< endl;
...
cout << "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\t\t\t\t\t\t\t\t-----------------------------------------" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\tTotal Members in GYM: " << tot_lines / 4 << "\n\n\t\t\t\t\t\t\t\t-------------------------------
----------\n\n";
cout << "\t\t\t\t\t\t\t\tPress any key to choose another option...";
getch();
}
...
if (back == "Y" || back == "y")
{
cout << "\n\n\t\t\t\t\t\t\t\tYou filled all Entries of " << i + 1 << "/" << en << " employee
successfully...";
getch();
cout << endl;
}
...
cout << "\t\t\t\t\t\t\t\t----------------------------------------------" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<1> Employee's ID :" << e[i].id << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<2> Employee's Name :" << e[i].name << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<3> Employee's Age :" << e[i].age << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<4> Employee's Designation :" << e[i].designation << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<5> Employee's Experience :" << e[i].experience << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t----------------------------------------------" << endl
<< endl;
cout << "\n\t\t\t\t\t\t\t\tPress any key to choose another option...";
...
cout << "\n\n\n\n\n\n\n\t\t\t\t\t\t---------------------------------------------------------------------------------------" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t\tDetails Of All The Employees In The GYM" << endl
<< endl;
cout << "\t\t\t\t\t\t---------------------------------------------------------------------------------------" << endl
<< endl;
cout << "\t\t\t\t\t\tID"
...
for (i = 0; i < employeeid; i++)
cout << "\t\t\t\t\t\t" << e[i].id << "\t\t\t" << e[i].name << "\t\t\t" << e[i].age << "\t\t\t" <<
e[i].designation << endl
<< endl;
cout << "\t\t\t\t\t\t---------------------------------------------------------------------------------------" << endl
<< endl;
cout << "\t\t\t\t\t\tPress any key to choose another option...";
...
endl
<< endl;
cout << "\t\t\t\t\t\t\t\t\tPay Record Of All The Employees In The GYM" << endl
<< endl;
cout << "\t\t\t\t\t\t--------------------------------------------------------------------------------" << endl
<< endl;
cout << "\t\t\t\t\t\tTotal Employees: " << counter << endl
<< endl;
cout << "\t\t\t\t\t\tEmployees that Received Pay:" << pay << endl
<< endl;
cout << "\t\t\t\t\t\tID" << "\t\t\t" << "NAME" << "\t\t\t" << "Designation" << "\t\t\t" << "Status\n\n";
for (int i = 0; i < employeeid; i++)
cout << "\t\t\t\t\t\t" << e[i].id << "\t\t\t" << e[i].name << "\t\t\t" << e[i].designation <<
"\t\t\t" << e[i].status << endl;
cout << "\t\t\t\t\t\t--------------------------------------------------------------------------------" << endl
<< endl;
cout << "\n\t\t\t\t\t\tPress any key to choose another option...";
...
cout << "\t\t\t\t\t| |\n";
cout << "\t\t\t\t\t| |\n";
cout << "\t\t\t\t\t| Made By - Jashanpreet Singh Manav Bhagat |\n";
cout << "\t\t\t\t\t| Harshit Anand |\n";
cout <<
...
<< endl;
cout << "\t\t\t\t\t\t\t\t<2> Enter into Employees's DataBase" << endl
<< endl;
...
system("cls");
cout << "\n\n";
cout << "\n\n\n\n\n\n\n\n\n\t\t\t\t\t\t\t\t*** Welcome To Employee's DataBase ***" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t----------------------------------------------" << endl
<< endl;
...
<< endl;
cout << "\t\t\t\t\t\t\t\t<3> Detail OF ALL The Employees In The GYM " << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<4> Total Number of Employees in GYM " << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<5> Go Back " << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t----------------------------------------------" << endl
...
cout << "\t\t\t\t\t\t\t\t--------------------------------------------" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<1> Record fee(member database)" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<2> View Recorded Fee(member database)" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<3> View members details(member database)" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t--------------------------------------------" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<4> Record Payment(employee database)" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<5> View Recorded Payment(employee database)" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<6> View employees details(employee database)" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t--------------------------------------------" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<7> Check and Balance(Overview)" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\t<8> Go back" << endl
<< endl;
cout << "\t\t\t\t\t\t\t\tEnter your choice: ";
...
<< endl;
cout << "\t\t\t\t\t\t\t\tTotal Fee Received: " << m1.memberfee << endl
<< endl;
...
system("cls");
cout << "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\t\t\t\t\t\t\tOOPS!!!!" << endl;
cout << "\t\t\t\t\t\t\tNote: No Record To Display plz Go Back And Enter Some
Entries...";
getch();
}
goto get_data;
